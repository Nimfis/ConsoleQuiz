...
namespace Test_SAVOIR__VIVRE
{
    public static class QuestionsData
    {
        ...
        {
            new Question("Który z przykładów dotyczących pozdrawiania jest prawidłowy?", new List<Answer>
            {
            ...
            new Question("Kto pierwszy mówi dzień dobry, osoba wchodzi do pomieszczenia czy osoby które się w pomieszczeniu znajdują?", new List<Answer>
            {
            ...
            new Question("W których z wymienionych sytuacji pozdrawiamy osoby nieznajome?", new List<Answer>
            {
            ...
            new Question("Czy prawdą jest jeśli chodzi o przedstawianie się, że?", new List<Answer>
            {
            ...
            new Question("Która z odpowiedzi jest prawidłowa? Kto komu podaje dłoń?", new List<Answer>
            {
            ...
            new Question("Czy będąc w grupie ściskając dłoń możemy ją uścisnąć tylko jednej osobie a resztę pominąć?", new List<Answer>
            {
            ...
            new Question("Jaki powinien być uścisk dłoni?", new List<Answer>
            {
            ...
            new Question("Jak przedstawić sobie wzajemnie osoby – mężczyznę i kobietę?", new List<Answer>
            {
            ...
            new Question("Jak przedstawić sobie wzajemnie osoby – młodszą i starszą?", new List<Answer>
            {
            ...
            new Question("Co robi się z pięknie ułożoną serwetką na stole, gdzie ją kładziemy?", new List<Answer>
            {
