...
namespace Test_SAVOIR__VIVRE
{
    public static class QuestionsData
    {
        ...
        {
            new QuestionModel("Który z przykładów dotyczących pozdrawiania jest prawidłowy?", new List<Answer>
            {
            ...
            new QuestionModel("Kto pierwszy mówi dzień dobry, osoba wchodzi do pomieszczenia czy osoby które się w pomieszczeniu znajdują?", new List<Answer>
            {
            ...
            new QuestionModel("W których z wymienionych sytuacji pozdrawiamy osoby nieznajome?", new List<Answer>
            {
            ...
            new QuestionModel("Czy prawdą jest jeśli chodzi o przedstawianie się, że?", new List<Answer>
            {
            ...
            new QuestionModel("Która z odpowiedzi jest prawidłowa? Kto komu podaje dłoń?", new List<Answer>
            {
            ...
            new QuestionModel("Czy będąc w grupie ściskając dłoń możemy ją uścisnąć tylko jednej osobie a resztę pominąć?", new List<Answer>
            {
            ...
            new QuestionModel("Jaki powinien być uścisk dłoni?", new List<Answer>
            {
            ...
            new QuestionModel("Jak przedstawić sobie wzajemnie osoby – mężczyznę i kobietę?", new List<Answer>
            {
            ...
            new QuestionModel("Jak przedstawić sobie wzajemnie osoby – młodszą i starszą?", new List<Answer>
            {
            ...
            new QuestionModel("Co robi się z pięknie ułożoną serwetką na stole, gdzie ją kładziemy?", new List<Answer>
            {
